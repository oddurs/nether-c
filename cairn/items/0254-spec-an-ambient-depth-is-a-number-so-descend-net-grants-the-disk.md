...
- [ ] §2.1 and §2.2 say whether δ is a number or a set, once
- [ ] A program holding only `net` that writes to the disk is rejected, or §1.1 and §8.2 state the subsumption
- [ ] §6.1 says what "within the granted capabilities" means
