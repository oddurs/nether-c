...
- [x] Is 6 (write the network) genuinely deeper than 5 (read), or are they siblings?
- [x] Should stratum 1 (Store) exist, or is reading the ledger simply pure?

## Acceptance criteria

- [x] A table with grant / cost / witness for all nine
- [x] The monotonicity law stated once, formally
- [x] `descend` scoping rules, including nesting and early return
